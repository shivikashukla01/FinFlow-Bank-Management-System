-- Drop junction tables and dependent tables first to clear foreign key references
DROP TABLE IF EXISTS LoanDocument;
DROP TABLE IF EXISTS EmployeeDocument;
DROP TABLE IF EXISTS GuarantorDocument;
DROP TABLE IF EXISTS CustomerDocument;
DROP TABLE IF EXISTS KYC;

-- Drop base Document table
...
-- Create CustomerDocument junction table
...
-- Create GuarantorDocument junction table
...
-- Create EmployeeDocument junction table
...
-- Create LoanDocument junction table
